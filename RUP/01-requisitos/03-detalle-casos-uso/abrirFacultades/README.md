...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Universidad *-- Facultad`: composición real, se navega desde dentro de la `Universidad` abierta, no es catálogo institucional plano
