...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/abrirMetodologiaDocente/especificacion.svg)|
|-|
...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/abrirMetodologiaDocente/wireframe.svg)|
|-|
...
|-|-|
|**Actor**|`Admin`|
|**Objetivo**|Consultar el detalle de una `MetodologiaDocente` concreta|
...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `MetodologiaDocente { codigo, descripcion }`, catálogo institucional de `Universidad`
