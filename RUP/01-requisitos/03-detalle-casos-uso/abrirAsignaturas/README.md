...
- Modelo del dominio -- `Asignatura` (nombre, ects, contenido, estado), catálogo independiente reutilizado por `AsignaturaGrado`
- Datos reales: `docs/scripts/seed/asignaturas.json` (repo privado)
