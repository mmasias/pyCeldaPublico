...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Universidad`, sin más atributos que `nombre` (implícito, no diagramado por ser demasiado simple)
