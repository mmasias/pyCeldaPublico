...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Profesor -u-|> Actor`; ni `Profesor` ni `Actor` muestran atributos en el diagrama de clases (`nombre`/`email` son datos reales de trabajo del seed, no están formalmente modelados -- ver nota de hallazgos pendientes en el README de la fase)
