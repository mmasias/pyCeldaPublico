...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `MetodologiaMateria{descripcionPropia}`, README: "vacío por defecto... si el director de una materia concreta necesita un matiz distinto, lo registra en `descripcionPropia`"
