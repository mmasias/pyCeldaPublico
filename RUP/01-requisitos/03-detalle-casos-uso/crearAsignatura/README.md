...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/crearAsignatura/wireframe.svg)|
|-|
...
- Modelo del dominio -- `Asignatura` (nombre, ects, contenido, estado); `estado` nace `Vigente` por defecto, sin pedirlo -- patrón C→U, igual que `crearResultadoAprendizaje()`
