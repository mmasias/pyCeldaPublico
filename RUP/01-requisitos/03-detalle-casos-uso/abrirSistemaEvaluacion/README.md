...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/abrirSistemaEvaluacion/especificacion.svg)|
|-|
...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/abrirSistemaEvaluacion/wireframe.svg)|
|-|
...
|-|-|
|**Actor**|`Admin`|
|**Objetivo**|Consultar el detalle de un `SistemaEvaluacion`|
