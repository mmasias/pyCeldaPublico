...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `CursoAcademico.semestreActivo`: "las notificaciones dirigidas al profesor se filtran por Guia.semestre == CursoAcademico.semestreActivo -- no es una relación estructural, es una condición de filtrado en el envío"
