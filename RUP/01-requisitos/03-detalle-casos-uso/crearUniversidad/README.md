...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/crearUniversidad/especificacion.svg)|
|-|
...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/crearUniversidad/wireframe.svg)|
|-|
...
|-|-|
|**Actor**|`Admin`|
|**Objetivo**|Dar de alta una `Universidad` en el catálogo institucional|
...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Universidad`, entidad raíz sin atributos de identificación en el diagrama (demasiado simple para listarlos, ver README de esa fase); `nombre` es el único dato real de trabajo
