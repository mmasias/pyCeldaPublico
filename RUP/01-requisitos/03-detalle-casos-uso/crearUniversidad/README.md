...
- Modelo del dominio -- `Universidad`, entidad raíz sin atributos de identificación en el diagrama (demasiado simple para listarlos, ver README de esa fase); `nombre` es el único dato real de trabajo
