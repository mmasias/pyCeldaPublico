...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `AsignaturaGrado o-r- MetodologiaDocente`; README, cascada en dos pasos y regla de consistencia (subconjunto de la `Materia`)
