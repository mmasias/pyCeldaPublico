...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `CursoAcademico.estado`: "corregir un dato mal introducido al crear (inicio/fin) es editarCursoAcademico(), bloqueado si el curso tiene alguna Guia asociada -- mismo criterio relacional que bloquea eliminarProfesor()/eliminarFacultad(), aplicado aquí a editar en vez de a borrar"
