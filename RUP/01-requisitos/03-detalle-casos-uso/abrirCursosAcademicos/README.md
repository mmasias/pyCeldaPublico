...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Universidad -- CursoAcademico`; regla de `estado`/elegibilidad de activación documentada en el README de esa fase
