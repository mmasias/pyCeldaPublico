...
- [Modelo del dominio](/RUP/00-modelo-del-dominio/README.md) -- entrada "`semestreDefault` (en `AsignaturaGrado`) es invariante", patrón catálogo+override
- [Modelo del dominio](/RUP/00-modelo-del-dominio/modeloDominio.puml) -- `Guia{semestre}`, `AsignaturaGrado{semestreDefault}`
