...
|![](/images/RUP/01-requisitos/03-detalle-casos-uso/crearMateria/especificacion.svg)|
|-|
...
- Modelo del dominio -- `Grado *-- Materia`, `Materia{nombre}`; `caracter` vive en `AsignaturaGrado`, no en `Materia` (una materia agrupa asignaturas de carácter distinto)
