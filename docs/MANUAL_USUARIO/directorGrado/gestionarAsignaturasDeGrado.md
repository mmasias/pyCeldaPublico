...
# Gestionar asignaturas de grado

## Qué es

Cada asignatura de grado es la versión concreta de una asignatura dentro de un grado y un curso: sus datos propios, sus requisitos previos, las metodologías docentes y resultados de aprendizaje que le aplican, y el reparto de sus actividades formativas.

## Cómo llegar

Desde la barra de navegación del grado, pulsar **Asignaturas**.
