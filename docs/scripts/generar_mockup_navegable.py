...
CONTEXTUAL_LABELS = {
    ...
    # Auditoría 11 ago 2026: familias abrir<Entidad>/abrir<Entidad>s con etiqueta
    # de paráfrasis del CU en vez del texto literal del botón -- mismo patrón que
    # abrirGuia()/aprobarGuia(), verificado contra cada wireframes.puml propio.
    ("abrirUniversidad", "abrirUniversidades"): "Volver al listado",
    ("abrirUniversidades", "crearUniversidad"): "Crear Universidad",
    ("abrirFacultad", "abrirFacultades"): "Volver al listado",
    ...
    ("abrirMateria", "asociarResultadoAprendizajeAMateria"): "Asociar Resultado de Aprendizaje",
    ("abrirMateria", "desasociarResultadoAprendizajeAMateria"): "Quitar",
    ...
    ("abrirProfesores", "eliminarProfesor"): "Eliminar",
    ("abrirCursoAcademico", "abrirCursosAcademicos"): "Volver al listado",
    ("abrirCursosAcademicos", "crearCursoAcademico"): "Crear Curso Académico",
    ("abrirCursosAcademicos", "abrirCursoAcademico"): "Abrir",
    ("abrirCursosAcademicos", "activarCursoAcademico"): "Activar",
    ("abrirMetodologiaDocente", "abrirMetodologiasDocentes"): "Volver al listado",
    ("abrirMetodologiasDocentes", "crearMetodologiaDocente"): "Crear Metodología Docente",
    ("abrirMetodologiasDocentes", "abrirMetodologiaDocente"): "Abrir",
    ("abrirMetodologiasDocentes", "eliminarMetodologiaDocente"): "Eliminar",
    ("abrirSistemaEvaluacion", "abrirSistemasEvaluacion"): "Volver al listado",
    ("abrirSistemasEvaluacion", "crearSistemaEvaluacion"): "Crear Sistema de Evaluación",
    ("abrirSistemasEvaluacion", "abrirSistemaEvaluacion"): "Abrir",
    ("abrirSistemasEvaluacion", "eliminarSistemaEvaluacion"): "Eliminar",
    ("abrirResultadoAprendizaje", "abrirResultadosAprendizaje"): "Volver al listado",
    ("abrirResultadosAprendizaje", "crearResultadoAprendizaje"): "Crear Resultado de Aprendizaje",
    ("abrirResultadosAprendizaje", "abrirResultadoAprendizaje"): "Abrir",
    ("abrirResultadosAprendizaje", "eliminarResultadoAprendizaje"): "Eliminar",
    ("abrirPonderacionEvaluacion", "abrirPonderacionesEvaluacion"): "Volver al listado",
    ("abrirReferenciaBibliografica", "abrirReferenciasBibliograficas"): "Volver al listado",
